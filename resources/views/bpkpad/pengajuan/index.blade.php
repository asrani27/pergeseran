      ...
      <div class="box">
        ...
        <form role="form" method="post" action="/pimpinan/pengajuan/1">
          ...
          <div class="box-footer text-center">
            <button type="button" class="btn btn-danger bpkpad-menolak" data-id="{{$data->id}}"> <i class="fa fa-times"></i>  Tolak Pengajuan</button>
            <button type="button" class="btn btn-primary bpkpad-menerima" data-id="{{$data->id}}"> <i class="fa fa-send"></i>  Terima Pengajuan</button>
          </div>
        </form>
      </div>
